...
#define STRING_CONFIG_H_AUTHOR "(Chris Warkocki, SKR 1.4, Bear, PINDA)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Elvira SKR"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 285.6 }
