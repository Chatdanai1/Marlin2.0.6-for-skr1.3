...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "G27 P2 \nM84 X Y E"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
    ...
    #define PE_LEDS_COMPLETED_TIME  (1*60) // (seconds) Time to keep the LED "done" color before restoring normal illumination
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       6000  // (ms) Delay for the filament to cool after retract.
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_9 "UBL Offset Step 1"
  #define USER_GCODE_9 "G28\nG1 X125 Y105 Z0.00\nM211 S0\nM0 Set Z Offset"

  #define USER_DESC_10 "UBL Offset Step 2"
  #define USER_GCODE_10 "M211 S1\nM500"

  #define USER_DESC_11 "Print Mesh Validation"
  #define USER_GCODE_11 "G28\nG26\nG28"

  #define USER_DESC_12 "Adjust Point Near" //Adjust nearest mesh point
  #define USER_GCODE_12 "G29 P4\nM500"
